...
set guifont=Source_Code_Pro_Black:h11                "设置英文字体，下面一行是中文字体
set guifontwide=Microsoft_YaHei:h11                 "设置字体:字号（字体名称空格用下划线代替）
...
"if empty(glob('~/vimfiles/autoload/plug.vim'))
 " silent !powershell curl 'https://raw.githubusercontent.com/junegunn/vim-plug/master/plug.vim' -outfile "vimfiles/autoload/plug.vim"
