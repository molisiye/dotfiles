...
local update_widget = function()
	if headphone_state then
		widget.widget = mat_icon(icons.color_icon(icons.headphone, ICON_COLORS[COLORS]), dpi(22))
	else
		widget.widget = mat_icon(icons.color_icon(icons.volume, ICON_COLORS[COLORS]), dpi(22))
	end
end
update_widget()
