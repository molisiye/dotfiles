...
theme.close_icon = icons.color_icon(icons.close, ICON_COLORS[COLORS])
theme.maximize_icon = icons.color_icon(icons.maximize, ICON_COLORS[COLORS])
theme.minimize_icon = icons.color_icon(icons.minus, ICON_COLORS[COLORS])
theme.float_icon = icons.color_icon(icons.plus, ICON_COLORS[COLORS])
