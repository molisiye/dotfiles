...
local function widget()
	...
	-- init buttons
	local lock_screen = mat_icon_button_rect(mat_icon(icons.color_icon(icons.lock, ICON_COLORS[COLORS]), dpi(24)))
	local sleep = mat_icon_button_rect(mat_icon(icons.color_icon(icons.sleep, ICON_COLORS[COLORS]), dpi(24)))
	local restart = mat_icon_button_rect(mat_icon(icons.color_icon(icons.restart, ICON_COLORS[COLORS]), dpi(24)))
	local shut_down = mat_icon_button_rect(mat_icon(icons.color_icon(icons.power, ICON_COLORS[COLORS]), dpi(24)))
	local log_out = mat_icon_button_rect(mat_icon(icons.color_icon(icons.logout, ICON_COLORS[COLORS]), dpi(24)))
