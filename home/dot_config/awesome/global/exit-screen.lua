...
local poweroff = build_button(icons.color_icon(icons.power, ICON_COLORS[COLORS]))
poweroff:connect_signal("button::release", function()
	poweroff_command()
end)

local reboot = build_button(icons.color_icon(icons.restart, ICON_COLORS[COLORS]))
reboot:connect_signal("button::release", function()
	reboot_command()
end)

local suspend = build_button(icons.color_icon(icons.sleep, ICON_COLORS[COLORS]))
suspend:connect_signal("button::release", function()
	suspend_command()
end)

local exit = build_button(icons.color_icon(icons.logout, ICON_COLORS[COLORS]))
exit:connect_signal("button::release", function()
	exit_command()
end)

local lock = build_button(icons.color_icon(icons.lock, ICON_COLORS[COLORS]))
