...
-- Spawn terminal
    ...
    awful.key(
        ...
        { description = "open scratchpad", group = "Bling" }
    ),
    -- launch rofi
    awful.key(
        { altkey },
    ...
    awful.key(
        ...
        "Print",
        function()
            awful.util.spawn_with_shell(apps.screenshot)
        end,
        { description = "Launch Screenshot app", group = "hotkeys" }
    ),
    -- help
    awful.key(
        { modkey },
